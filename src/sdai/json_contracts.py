...
_STABLE_CONTRACTS = (
    ...
    StableJsonContract(
        "artifact.explain",
        "sdai.artifact-state/v1",
        "sdai artifact explain FEATURE ARTIFACT --json",
        "sdai.artifact_state_cli",
        "read",
    ),
    StableJsonContract(
        "artifact.status",
        "sdai.artifact-state-report/v1",
        "sdai artifact status FEATURE --json",
        "sdai.artifact_state_cli",
        "status",
    ),
    StableJsonContract(
    ...
    StableJsonContract(
        "eval.report",
        "sdai.eval-report/v1",
        "sdai skill|agent eval NAME --json",
        "sdai.evals",
        "analysis",
    ),
    StableJsonContract(
    ...
    StableJsonContract(
        "pack.certification",
        "sdai.pack-certification-decision/v1",
        "sdai pack certification --json",
        "sdai.pack_cli",
        "analysis",
    ),
    StableJsonContract(
        "pack.info",
        "sdai.pack-info/v1",
        "sdai pack info COORDINATE --json",
        "sdai.pack_cli",
        "read",
    ),
    StableJsonContract(
        "pack.lifecycle",
        "sdai.pack-lifecycle-result/v1",
        "sdai pack install|update|remove ... --json",
        "sdai.pack_cli",
        "lifecycle",
    ),
    StableJsonContract(
        "pack.outdated",
        "sdai.pack-outdated/v1",
        "sdai pack outdated --json",
        "sdai.pack_cli",
        "status",
    ),
    StableJsonContract(
        "pack.search",
        "sdai.pack-search/v1",
        "sdai pack search QUERY --json",
        "sdai.pack_cli",
        "read",
    ),
    StableJsonContract(
        "schema.definition",
        "sdai.artifact-schema-definition/v1",
        "sdai schema show ARTIFACT --json",
        "sdai.schema_cli",
        "read",
    ),
    StableJsonContract(
        "schema.graph",
        "sdai.artifact-schema-graph/v1",
        "sdai schema list|validate|graph --json",
        "sdai.schema_cli",
        "read",
    ),
    StableJsonContract(
    ...
    StableJsonContract(
        "spec.diff",
        "sdai.spec-diff/v1",
        "sdai spec diff FEATURE --json",
        "sdai.spec_cli",
        "analysis",
    ),
    StableJsonContract(
        "spec.promotion-approval",
        "sdai.spec-promotion-approval/v1",
        "sdai spec approve FEATURE --by ACTOR --json",
        "sdai.spec_cli",
        "lifecycle",
    ),
    StableJsonContract(
        "spec.promotion-preview",
        "sdai.spec-promotion-preview/v1",
        "sdai spec promote FEATURE --dry-run --json",
        "sdai.spec_cli",
        "read",
    ),
    StableJsonContract(
        "spec.promotion-result",
        "sdai.spec-promotion-result/v1",
        "sdai spec promote FEATURE --json",
        "sdai.spec_cli",
        "lifecycle",
    ),
    StableJsonContract(
        "spec.validation",
        "sdai.spec-validation/v1",
    ...
    StableJsonContract(
        "store.context",
        "sdai.specification-store-context/v1",
        "sdai store context --json",
        "sdai.specification_store_lifecycle",
        "read",
    ),
    StableJsonContract(
        "store.create",
        "sdai.specification-store-create-result/v1",
        "sdai store create ... --json",
        "sdai.specification_store_lifecycle",
        "lifecycle",
    ),
    StableJsonContract(
        "store.doctor",
        "sdai.specification-store-doctor/v1",
        "sdai store doctor --json",
        "sdai.specification_store_lifecycle",
        "status",
    ),
    StableJsonContract(
        "store.list",
        "sdai.specification-store-list/v1",
        "sdai store list --json",
        "sdai.specification_store_lifecycle",
        "read",
    ),
    StableJsonContract(
        "store.register",
        "sdai.specification-store-register-result/v1",
        "sdai store register PATH --json",
        "sdai.specification_store_lifecycle",
        "lifecycle",
    ),
    StableJsonContract(
    ...
    StableJsonContract(
        "trace.policy",
        "sdai.trace-policy-report/v1",
        "sdai trace policy FEATURE --json",
        "sdai.trace_policy",
        "analysis",
    ),
    StableJsonContract(
    ...
    StableJsonContract(
        "workflow.explain-current",
        "sdai.workflow-resolution/v2",
        "sdai workflow explain NAME --json (workflowVersion >= 9)",
        "sdai.workflow_graph",
        "read",
    ),
    StableJsonContract(
        "workflow.explain-legacy",
        "sdai.workflow-definition/v1",
        "sdai workflow explain NAME --json (workflowVersion < 9)",
        "sdai.workflow_cli",
        "read",
    ),
