...
from sdai.schema_cli import add_schema_parser, run_schema_command
...
def _print_top_level_help() -> None:
    ...
    print(
        ...
        "  sdai workflow status <feature> --run <run-id> [--json]\n"
        "  sdai workflow resume <feature> --run <run-id> [--input NAME=YAML_VALUE] [--json]\n"
